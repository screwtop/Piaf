...
menu .menubar.file
	...
	.menubar.file add command -label "Save" -command {}
...
# Insert menu:
menu .menubar.insert
.menubar.insert add command -label "LaTeX Figure" -command ::edita::latex::figure
...
menu .menubar.transform
	.menubar.transform add command -label "Indent" -command {transform_selection ::edita::transform::indent}
	.menubar.transform add command -label "Case > Upper" -command {transform_selection ::edita::transform::uppercase}
	.menubar.transform add command -label "Case > Lower" -command {transform_selection ::edita::transform::lowercase}
	.menubar.transform add command -label "Linebreaks > CR" -command {transform_selection ::edita::transform::crlinebreaks}
	.menubar.transform add command -label "Linebreaks > LF" -command {transform_selection ::edita::transform::lflinebreaks}
	.menubar.transform add command -label "Linebreaks > CRLF" -command {transform_selection ::edita::transform::crlflinebreaks}
	.menubar.transform add command -label "Rot-13" -command {transform_selection ::edita::transform::rot13}
	.menubar.transform add command -label "Sort" -command {transform_selection ::edita::transform::sort}
	.menubar.transform add command -label "Reverse" -command {transform_selection ::edita::transform::reverse}
	.menubar.transform add command -label "Whitespace: Remove Trailing" -command {transform_selection ::edita::transform::removetrailingwhitespace}
...
menu .popup_menu
	...
	menu .popup_menu.transform
		.popup_menu.transform add command -label "Case: Uppercase" -command {transform_selection ::edita::transform::uppercase}
		.popup_menu.transform add command -label "Case: Lowercase" -command {transform_selection ::edita::transform::lowercase}
		.popup_menu.transform add command -label "Indent" -command {transform_selection ::edita::transform::indent}
		.popup_menu.transform add command -label "Reverse" -command {transform_selection ::edita::transform::reverse}
		.popup_menu.transform add command -label "Rot-13" -command {transform_selection ::edita::transform::rot13}
		.popup_menu.transform add command -label "Sort" -command {transform_selection ::edita::transform::sort}
